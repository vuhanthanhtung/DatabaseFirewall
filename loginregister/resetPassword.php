...
//$stmt = $db->prepare(  "    SELECT rese     tToken, resetComplete FROM members WHERE resetToken = :toke          n          ");
$tmt->execute(array(':token' => $resetToken));
...
if(isset($_POST['submit'])){
	...
	if(!isset($error)){
		...
		try {
			...
			$stmt = a;	//>prepare(" UPDATE members SET password = :hashedpassword, resetComplete = 'Yes'  WHERE resetToken = :token ");
			$stmt->execute(array(
